...
User->>Système: Clique sur une catégorie de la page d'accueil.
...
User->>Système: Clique sur panier ou ajouter au panier.
alt User non connecté
Système->>User: Affiche un formulaire d'authentification.
User->>Système: Saisit les champs d'authentification.
Système->>User: Valide l'authentification
else User non inscrit
Système->>User: Affiche un formulaire d'authentification.
User->>Système: Clique sur "s'inscrire".
Système->>User: Affiche le formulaire d'inscritpion.
User->>Système: Entre ses coordonnées.
Système->>User: valide l'inscription et le client est connecté.

end


Système->>User: Affiche le formulaire  de moyens de paiements et de livraison.
