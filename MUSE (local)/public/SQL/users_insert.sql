...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `user_name`, `user_lastname`, `birthdate`, `phone_number`, `is_verified`, `register_date`, `vat`, `pro`, `pro_company_name`, `pro_duns`, `pro_job_position`, `agree_terms`) VALUES
	...
	(5, 'client@muse.com', '["ROLE_CLIENT","ROLE_USER"]', '$2y$13$b8Nnv9pJpEbCSFMYlB6Dw.PUIg.9dMSXvTFjIe1BN3G1MmpQ6Gine', 'client', 'client', '2022-12-12 00:00:00', '0999999999', 1, '2022-12-12 00:00:00', 0.20, 0, NULL, NULL, NULL, 1),
